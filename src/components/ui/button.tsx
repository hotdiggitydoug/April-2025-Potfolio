/**
 * Variant styles for link-styled controls. The full `<Button>` primitive from
 * shadcn is omitted until the app needs it—re-add `@base-ui/react/button` usage if so.
 */
